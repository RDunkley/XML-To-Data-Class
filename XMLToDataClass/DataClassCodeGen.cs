...
namespace XMLToDataClass
{
	...
	public static class DataClassCodeGen
	{
		...
		/// </summary>
		/// <param name="element"><see cref="ElementInfo"/> containing lookup information on the XML file.</param>
		/// <param name="codeOutputFolder">Full path to the folder to generate the code in.</param>
		/// <param name="nameSpace">Namespace to be specified for the files.</param>
		/// <exception cref="ArgumentNullException">One of the input parameters is a null reference.</exception>
		/// <exception cref="ArgumentException"><i>name</i> or <i>nameSpace</i> is an empty string or <i>codeOutputFolder</i> is not valid.</exception>
		public static void GenerateDataClass(ElementInfo element, string codeOutputFolder, string nameSpace)
		{
			if (element == null)

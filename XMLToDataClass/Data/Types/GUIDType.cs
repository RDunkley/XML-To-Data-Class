//********************************************************************************************************************************
// Filename:    GUIDType.cs
// Owner:       Richard Dunkley
// Description: Provides support for the C# Guid type.
//********************************************************************************************************************************
...
{
	public class GUIDType : BaseType
	{
		#region Methods

		public GUIDType(DataInfo info, string[] possibleValues) : base(info, possibleValues)
		{
			Type = DataType.GUID;
			IsNullable = false;
			DisplayName = "GUID";
		...
		/// <summary>
		///   Generates the export method code for the GUID.
		/// </summary>
		...
		/// <summary>
		///   Generates the import method code for the GUID.
		/// </summary>
		...
		public override string[] GenerateImportMethodCode()
		{
			...
			codeLines.Add(string.Format("{0} = Guid.Parse(value);", mInfo.PropertyName));
			return codeLines.ToArray();
		}

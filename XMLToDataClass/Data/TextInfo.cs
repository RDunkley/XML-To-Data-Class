//********************************************************************************************************************************
// Filename:    TextInfo.cs
// Owner:       Richard Dunkley
// Description: Class which represents a 'Text' XML Node.
//********************************************************************************************************************************
...
namespace XMLToDataClass.Data
{
	public class TextInfo
	{
		...
		public TextInfo(XmlNode[] nodes)
		{
			...
			Info = new DataInfo("Text", possibleValues, isOptional, canBeEmpty);
		...
		/// <summary>
		///   Finds all the possible values of Text in the <paramref name="nodes"/>.
		/// </summary>
